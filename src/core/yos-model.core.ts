...
export abstract class YosModel {
   ...
   */
  find<T extends YosModel>(this: new (...args: any[]) => T, ids?: Fortune.ID | Fortune.ID[], options?: Fortune.Options, include?: Fortune.Include, meta?: object): Promise<Fortune.Response> {
